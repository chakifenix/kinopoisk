...
public class SearchViewController: UIViewController{
    ...
    open var dataSource: SearchViewDataSource?
    ...
    open var searchBarBackgroundColor: UIColor = SearchViewDefaults.searchBarColor {
        didSet {
    ...
    private (set) open var cellIdentifier: String = SearchViewDefaults.reuseIdetentifer
    ...
    override public func viewDidLoad() {
        ...
        self.view.backgroundColor = SearchViewDefaults.backgroundColor
        ...
        let tap = UITapGestureRecognizer(target: self, action: #selector(SearchViewController.didTapBackground(sender:)))
        tap.delegate = self
        self.view.addGestureRecognizer(tap)
        
        //add observers to listen to keyboard events
        NotificationCenter.default.addObserver(self, selector: #selector(SearchViewController.keyboardWillShow(notification:)), name: UIResponder.keyboardWillShowNotification, object: nil)
        NotificationCenter.default.addObserver(self, selector: #selector(SearchViewController.keyboardWillHide(notification:)), name: UIResponder.keyboardWillHideNotification, object: nil)
    }
...
extension SearchViewController: WrapperDataSource {
